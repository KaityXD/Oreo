...
public class KickText extends Command {

    public KickText() {
        this.name = "kick";
        this.help = "kick someone from a guild";
                    ...
                    if (m.canInteract(mm)) {
                        event.getGuild().kick(mm)
                                ...
                                .queue(success -> {
                                    ...
                                    event.replySuccess("Kicked **%s** for *%s*".formatted(mm.getEffectiveName(), reason));
                                });
                    } else {
